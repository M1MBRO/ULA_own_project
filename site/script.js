...
(() => {
  ...
  const DICT = {
    uk: {
      ...
      'hero.badge': 'MVP · Перші 10 клієнтів',
      'hero.title.line1': 'Голосовий AI,',
      'hero.title.line2': 'що приймає кожен дзвінок,',
      'hero.title.line3': '24/7.',
      'hero.sub': 'Для українських бізнесів, що не можуть дозволити собі пропустити жодного клієнта. Голос. Telegram. Google Sheets. Все під ключ.',
      'hero.cta.demo': 'Спробувати демо',
      'hero.cta.lead': 'Стати раннім клієнтом',
      'hero.bullet.1': 'Без зміни вашого номера',
      'hero.bullet.2': 'Запуск за 3–5 днів',
      ...
      'faq.a2': '3–5 робочих днів від погодження ТЗ. День 1 — інтерв\'ю і скрипти. Дні 2–3 — налаштування. День 4 — тестування. День 5 — запуск.',
    ...
    en: {
      ...
      'hero.badge': 'MVP · First 10 customers',
      'hero.title.line1': 'Voice AI',
      'hero.title.line2': 'that answers every call,',
      'hero.title.line3': '24/7.',
      'hero.sub': 'For Ukrainian businesses that can\'t afford to miss a single customer. Voice. Telegram. Google Sheets. Done for you.',
      'hero.cta.demo': 'Try the demo',
      'hero.cta.lead': 'Become an early customer',
      'hero.bullet.1': 'Keep your existing number',
      'hero.bullet.2': 'Launch in 3–5 days',
      ...
      'faq.a2': '3–5 business days after spec approval. Day 1 — interview and scripts. Days 2–3 — setup. Day 4 — testing. Day 5 — launch.',
